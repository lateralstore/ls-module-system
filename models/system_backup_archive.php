	...
	class System_Backup_Archive extends Db_ActiveRecord 
	{
		...
		public function define_form_fields($context = null)
		{
			...
			if ($this->is_new_record())
				$this->add_form_field('archive_uploaded_dir')->comment('Enable this option if you want to include uploaded files (website resource files - images, CSS, JavaScript files, product and category images, etc.) to the archive. Enabling this option can significantly increase the backup file size. When this option is disabled only the database content will be archived.');
		...
		/**
		 * Triggered before backup archive is created.
		 * Example:
		 * <pre>
		...
		/**
		 * Triggered after backup archive is created.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
		...
		/**
		 * Triggered before backup archive is restored.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
